...
def to_int(
    ...
    if value is None:
        logger.debug(
            ...
            extra={"function": function_name, "input_type": "None", **log_context}
        )
        return default
    ...
    if isinstance(value, int) and not isinstance(value, bool):
        logger.debug(
            ...
            extra={"function": function_name, "input_type": "int", **log_context}
        )
        return value
    ...
    if strict and isinstance(value, bool):
        logger.debug(
            ...
            extra={"function": function_name, "input_type": "bool", "strict_mode": True, **log_context}
        )
        return default
    ...
    if strict and isinstance(value, float):
        logger.debug(
            ...
            extra={"function": function_name, "input_type": "float", "strict_mode": True, **log_context}
        )
        return default
    ...
    try:
        ...
        logger.debug(
            ...
            extra={"function": function_name, "input_type": type(value).__name__, "result": result, **log_context}
        )
        return result
    except (ValueError, TypeError) as e:
        logger.debug(
            f"转换为整数: 无法将 {value} ({type(value).__name__}) 转换为整数: {str(e)}",
            extra={"function": function_name, "input_type": type(value).__name__, "error": str(e), **log_context}
        )
        return default
...
def to_float(
    ...
    if isinstance(value, float):
        logger.debug(
            ...
            extra={"function": function_name, "input_type": "float", **log_context}
        )
        return value
    ...
    if isinstance(value, int) and not isinstance(value, bool):
        ...
        logger.debug(
            ...
            extra={"function": function_name, "input_type": "int", "result": result, **log_context}
        )
        return result
...
def to_bool(
    ...
    if isinstance(value, bool):
        logger.debug(
            ...
            extra={"function": function_name, "input_type": "bool", **log_context}
        )
        return value
    ...
    if isinstance(value, str):
        ...
        if value_lower in ('true', 'yes', 'y', '1', 't'):
            logger.debug(
                ...
                extra={"function": function_name, "input_type": "str", "result": True, **log_context}
            )
            return True
        ...
        if value_lower in ('false', 'no', 'n', '0', 'f'):
            logger.debug(
                ...
                extra={"function": function_name, "input_type": "str", "result": False, **log_context}
            )
            return False
    ...
    if isinstance(value, str):
        if format_spec is None:
            logger.debug(
                ...
                extra={"function": function_name, "input_type": "str", **log_context}
            )
            return value
        else:
            ...
            logger.debug(
                ...
                extra={"function": function_name, "input_type": "str", "format_spec": format_spec, "result": result, **log_context}
            )
            return result
    ...
    try:
        ...
        if format_spec is not None:
            ...
            logger.debug(
                ...
                extra={"function": function_name, "input_type": type(value).__name__, "format_spec": format_spec, "result": result, **log_context}
            )
            return result
...
def to_date(
    ...
    if isinstance(value, datetime.date) and not isinstance(value, datetime.datetime):
        logger.debug(
            ...
            extra={"function": function_name, "input_type": "date", **log_context}
        )
        return value
    ...
    if isinstance(value, datetime.datetime):
        ...
        logger.debug(
            ...
            extra={"function": function_name, "input_type": "datetime", "result": str(result), **log_context}
        )
        return result
    ...
    if isinstance(value, str):
        ...
        for fmt in formats:
            try:
                ...
                logger.debug(
                    ...
                    extra={"function": function_name, "input_type": "str", "format": fmt, "result": str(result), **log_context}
                )
                return result
            except ValueError:
                continue
        ...
        logger.debug(
            ...
            extra={"function": function_name, "input_type": "str", "formats_tried": len(formats), **log_context}
        )
        return default
    ...
    if isinstance(value, (int, float)):
        try:
            ...
            logger.debug(
                ...
                extra={"function": function_name, "input_type": type(value).__name__, "result": str(result), **log_context}
            )
            return result
    ...
    logger.debug(
        ...
        extra={"function": function_name, "input_type": type(value).__name__, **log_context}
    )
    return default
...
def to_datetime(
    ...
    if isinstance(value, datetime.datetime):
        logger.debug(
            ...
            extra={"function": function_name, "input_type": "datetime", **log_context}
        )
        return value
    ...
    if isinstance(value, datetime.date):
        ...
        logger.debug(
            ...
            extra={"function": function_name, "input_type": "date", "result": str(result), **log_context}
        )
        return result
...
def to_list(
        ...
        if item_type:
            try:
                ...
                logger.debug(
                    ...
                    extra={"function": function_name, "input_type": "list", "item_type": item_type.__name__, **log_context}
                )
                return result
            except (ValueError, TypeError) as e:
                logger.warning(
                    f"转换为列表: 转换列表元素类型时出错: {str(e)}",
                    extra={"function": function_name, "input_type": "list", "error": str(e), **log_context}
                )
                return default
        else:
            logger.debug(
                f"转换为列表: 输入已经是列表，长度为 {len(value)}",
                extra={"function": function_name, "input_type": "list", "length": len(value), **log_context}
            )
            return value
        ...
        if item_type:
            try:
                ...
                logger.debug(
                    ...
                    extra={"function": function_name, "input_type": "tuple", "item_type": item_type.__name__, **log_context}
                )
                return result
            except (ValueError, TypeError) as e:
                logger.warning(
                    f"转换为列表: 转换元组元素类型时出错: {str(e)}",
                    extra={"function": function_name, "input_type": "tuple", "error": str(e), **log_context}
                )
                return default
        else:
            result = list(value)
            logger.debug(
                ...
                extra={"function": function_name, "input_type": "tuple", "length": len(result), **log_context}
            )
            return result
        ...
        if item_type:
            try:
                ...
                logger.debug(
                    ...
                    extra={"function": function_name, "input_type": "set", "item_type": item_type.__name__, **log_context}
                )
                return result
            except (ValueError, TypeError) as e:
                logger.warning(
                    f"转换为列表: 转换集合元素类型时出错: {str(e)}",
                    extra={"function": function_name, "input_type": "set", "error": str(e), **log_context}
                )
                return default
        else:
            result = list(value)
            logger.debug(
                ...
                extra={"function": function_name, "input_type": "set", "length": len(result), **log_context}
            )
            return result
    ...
    if isinstance(value, str):
        ...
        if not value.strip():
            ...
            logger.debug(
                ...
                extra={"function": function_name, "input_type": "str", "length": 0, **log_context}
            )
            return empty_list
        ...
        if item_type:
            try:
                ...
                logger.debug(
                    ...
                    extra={"function": function_name, "input_type": "str", "item_type": item_type.__name__, "length": len(result), **log_context}
                )
                return result
            except (ValueError, TypeError) as e:
                logger.warning(
                    f"转换为列表: 转换字符串分割后的元素类型时出错: {str(e)}",
                    extra={"function": function_name, "input_type": "str", "error": str(e), **log_context}
                )
                return default
        else:
            logger.debug(
                f"转换为列表: 将字符串 '{value}' 分割为列表，长度为 {len(parts)}",
                extra={"function": function_name, "input_type": "str", "length": len(parts), **log_context}
            )
            return parts
    ...
    if isinstance(value, dict):
        ...
        logger.debug(
            ...
            extra={"function": function_name, "input_type": "dict", "length": len(result), **log_context}
        )
        return result
                ...
                if item_type:
                    try:
                        ...
                        logger.debug(
                            ...
                            extra={"function": function_name, "input_type": "json_str", "item_type": item_type.__name__, **log_context}
                        )
                        return result
                    except (ValueError, TypeError) as e:
                        logger.warning(
                            f"转换为列表: 转换JSON解析后的元素类型时出错: {str(e)}",
                            extra={"function": function_name, "input_type": "json_str", "error": str(e), **log_context}
                        )
                        return default
                else:
                    logger.debug(
                        f"转换为列表: 将JSON字符串解析为列表，长度为 {len(parsed)}",
                        extra={"function": function_name, "input_type": "json_str", "length": len(parsed), **log_context}
                    )
                    return parsed
        ...
        if key_type or value_type:
            try:
                ...
                logger.warning(
                    ...
                    extra={"function": function_name, "input_type": "dict", "error": str(e), **log_context}
                )
                return default
        else:
            logger.debug(
                f"转换为字典: 输入已经是字典，键数量为 {len(value)}",
                extra={"function": function_name, "input_type": "dict", "length": len(value), **log_context}
            )
            return value
        ...
        try:
            ...
            if isinstance(parsed, dict):
                ...
                logger.warning(
                    ...
                    extra={"function": function_name, "input_type": "json_str", "parsed_type": type(parsed).__name__, **log_context}
                )
                return default
...
def bytes_to_human_readable(
    ...
    if size_bytes < 0:
        logger.error(
            ...
            extra={"function": function_name, "size_bytes": size_bytes, **log_context}
        )
...
def seconds_to_human_readable(
    ...
    if seconds < 0:
        logger.error(
            ...
            extra={"function": function_name, "seconds": seconds, **log_context}
        )
    ...
    if format_type not in valid_formats:
        logger.warning(
            ...
            extra={"function": function_name, "format_type": format_type, **log_context}
        )
        format_type = 'full'
    ...
    if format_type == 'iso':
        ...
        logger.debug(
            ...
            extra={"function": function_name, "seconds": seconds, "result": result, **log_context}
        )
        return result
