...
def render_assistant():
    ...
    return render_template('web/assistant.html', 
                          user=user, 
                          chat=chat, 
                          messages=messages, 
                          form=chat_form)
...
def render_chat_history():
    ...
    return render_template('web/chat_history.html', 
                          user=user, 
                          chats=chats)
...
def render_chat_detail(chat_id):
    ...
    return render_template('web/chat_detail.html', 
                          user=user, 
                          chat=chat, 
                          messages=messages, 
                          form=chat_form)
...
def render_settings():
    ...
    form.enable_sound.data = user.preferences.get('enable_sound', True) if hasattr(user, 'preferences') and user.preferences else True
