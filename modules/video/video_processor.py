...
class VideoProcessor:
        ...
        try:
            ...
            if isinstance(video_source, (str, Path)):
                ...
                temp_path = os.path.join(
                    self.temp_dir, f"temp_video_{uuid.uuid4()}.mp4")
    ...
    def extract_frames(self,
        ...
        try:
            ...
            # 设置帧提取参数
            target_fps = fps if fps is not None else self.config.get(
                "default_fps", 1)
    ...
    def create_timelapse(self,
        ...
        try:
            ...
            out_width, out_height = resolution if resolution is not None else (
            ...
            while True:
                ...
                if mean_diff > threshold:
                    ...
                    key_frame_path = os.path.join(
                        output_dir, f"keyframe_{key_frame_count:04d}.jpg")
                    ...
                    try:
                        ...
                        if processed_frame.shape[1] != out_width or processed_frame.shape[0] != out_height:
                            processed_frame = cv2.resize(
                                processed_frame, (out_width, out_height))
