...
def test_basic_config():
    ...
    # 不打印敏感信息
    print(f"API密钥存在: {'是' if 'api' in cred_cfg and 'key' in cred_cfg['api'] else '否'}")
...
def test_environment_override():
    ...
    # 设置环境变量
    os.environ[get_standardized_env_var_name("API_SERVER_URL")] = "http://override-api.example.com"
