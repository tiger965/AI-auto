...
class TestTrainingAPI(APITestBase):
    ...
    def test_get_model_details(self):
        ...
        response = self.get(f"training/models/{self.test_model_id}", headers=headers)
    ...
    def test_get_dataset_details(self):
        ...
        response = self.get(f"training/datasets/{self.test_dataset_id}", headers=headers)
    ...
    def test_get_job_details(self):
        ...
        response = self.get(f"training/jobs/{self.test_job_id}", headers=headers)
    ...
    def test_cancel_job(self):
        ...
        response = self.post(f"training/jobs/{self.test_job_id}/cancel", data={}, headers=headers)
    ...
    def test_evaluate_model(self):
        ...
        response = self.post(f"training/models/{self.test_model_id}/evaluate", 
    ...
    def test_model_status_handling(self, model_status: str):
        ...
        if self.mock_enabled:
            ...
            headers = self._get_headers_with_token()
            response = self.get(f"training/models/model-{model_status}", headers=headers)
            ...
            if model_status == "training":
                ...
                response = self.post(f"training/models/model-{model_status}/evaluate", 
                                   data=data, headers=headers)
