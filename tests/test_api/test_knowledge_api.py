...
class TestKnowledgeAPI(APITestBase):
    ...
    def test_get_knowledge_database_details(self):
        ...
        response = self.get(f"knowledge/databases/{self.test_kb_id}", headers=headers)
    ...
    def test_query_knowledge(self):
        ...
        response = self.post(f"knowledge/databases/{self.test_kb_id}/query", 
    ...
    def test_upload_document(self):
        ...
        response = self.post(f"knowledge/databases/{self.test_kb_id}/documents", 
                           data=data, headers=headers)
    ...
    def test_delete_document(self):
        ...
        response = self.delete(f"knowledge/databases/{self.test_kb_id}/documents/{self.test_document_id}", 
                             headers=headers)
    ...
    def test_query_nonexistent_kb(self):
        ...
        response = self.post("knowledge/databases/nonexistent-kb/query", 
                           data=data, headers=headers)
    ...
    def test_query_performance(self, query_length: int):
        ...
        data = {
            "query": long_query[:query_length],
            "max_results": 5
        }
        
        elapsed = self.measure_performance(
            self.post, f"knowledge/databases/{self.test_kb_id}/query", 
            data=data, headers=headers
        )
