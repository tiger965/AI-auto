...
class TestObjectDetection(unittest.TestCase):
    ...
    def test_object_detection_with_threshold(self):
        ...
        for threshold in thresholds:
            detections = self.detector.detect_objects(
                test_file, confidence_threshold=threshold
            )
    ...
    def test_mock_detector(self, mock_detect):
        ...
        mock_detect.return_value = [
            {"class": "rectangle", "confidence": 0.95,
                "bbox": [100, 100, 200, 200]},
            {"class": "circle", "confidence": 0.90,
    ...
    def test_specific_object_detection(self):
        ...
        # 只检测矩形
        rectangles = self.detector.detect_objects(
            test_file, classes=["rectangle"])
