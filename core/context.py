...
class PersistenceHandler:
    ...
    def delete(self, context_id: str) -> bool:
        ...
        raise NotImplementedError(
            "Persistence handlers must implement delete()")
...
class FileSystemPersistenceHandler(PersistenceHandler):
    ...
    def __init__(self, storage_dir: str = None):
        ...
        self._storage_dir = storage_dir or config.get(
            "storage_dir", "storage/contexts")

        # Create directory if it doesn't exist
        os.makedirs(self._storage_dir, exist_ok=True)
        self._logger.debug(
            f"Persistence handler using storage directory: {self._storage_dir}"
        )
    ...
    def load(self, context_id: str) -> Optional[Dict[str, Any]]:
        ...
        if not file_path.exists():
            self._logger.debug(
                f"Context {context_id} not found at {file_path}")
            return None
    ...
    def delete(self, context_id: str) -> bool:
        ...
        try:
            os.remove(file_path)
            self._logger.debug(
                f"Deleted context {context_id} from {file_path}")
            return True
        except Exception as e:
...
class Context:
    ...
    def __init__(
        self, context_id: Optional[str] = None, data: Optional[Dict[str, Any]] = None
    ):
...
class ContextManager:
    ...
    def __init__(self, config_section: str = "context"):
        ...
        self._logger.info(
            f"Context manager initialized with {persistence_type} persistence"
        )
    ...
    def reload_config(self, config_section: str = "context") -> None:
        ...
        self._logger.debug(
            f"Context manager configuration reloaded from section: {config_section}"
        )
    ...
    def get_context(
        self, context_id: str, load_if_needed: bool = True
    ) -> Optional[Context]:
        ...
        if load_if_needed:
            ...
            if data:
                ...
                self._logger.debug(
                    f"Loaded context from persistence: {context_id}")
                return context
    ...
    def save_context(self, context: Context) -> bool:
        ...
        data = {"data": context.get_all(), "metadata": context.get_metadata()}
